...
urlpatterns = [
    ...
    path('lookup_guest/<guest_ID>', views.lookup_guest, name = 'lookup_guest'),
    path('linked_proxy_form/<language>/<internal_ID>/<guest_ID>', views.linked_proxy_form, name = 'linked_proxy_form'),
    path('new_guest_created/<guest_ID>', views.new_guest_created, name = 'new_guest_created'),
