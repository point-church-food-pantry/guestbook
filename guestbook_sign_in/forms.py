...
class SignInInput(forms.Form):
    ...
    signature = JSignatureField(required = True, error_messages = {'required' : 'Please fill out the client signature.'})
    ...
    agency_representative_signature = JSignatureField(required = True, error_messages = {'required' : 'Please fill out the agency representative signature.'})
